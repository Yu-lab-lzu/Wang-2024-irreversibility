...
load('Data_processed_emotion.mat','cell_IDs','spike_times','stimuli_lengths','task_3','num_brain')
...
save('transitions_emotion_N6_4000.mat','n', 'num_stimuli','num_cellSample',...
