...
%%
load('rest_signals','rest_all')      


load('sub_middle_sup_260.mat','sub_260_1')
rest_all = rest_all(:,:,sub_260_1);
...
save('Data_processed_rest_1200_1','cell_IDs','spike_times','stimuli_lengths','task_3','num_brain','stimuli_time','std_bold')
